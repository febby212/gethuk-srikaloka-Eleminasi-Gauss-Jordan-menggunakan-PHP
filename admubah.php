...
<head>
    ...
    <title>Ubah Persamaan | Admin</title>
                ...
                <div class="py-2 inline-block min-w-full sm:px-6 lg:px-8">
                    <div class="overflow-hidden">
                        <table class="min-w-full">
                            ...
                            <?php
                            include "db.php";
                            $sql = "SELECT * FROM hitung ORDER BY id_barang DESC";
                            ...
                            ?>
                                <tbody>
                                    <tr class="bg-white border-b text-center transition duration-300 ease-in-out hover:bg-gray-100">
                                        ...
                                        <?php echo $data["singkong1"]; ?>
                                        </td>
                                        <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                        <?php echo $data["singkong2"]; ?>
                                        </td>
                                        <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                        <?php echo $data["singkong3"]; ?>
                                        </td>
                                        <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                        <?php echo $data["gula1"]; ?>
                                        </td>
                                        ...
                                        <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                        <?php echo $data["isian1"]; ?>
                                        </td>
                                        <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                        <?php echo $data["isian2"]; ?>
                                        </td>
                                        <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                        <?php echo $data["isian3"]; ?>
                                        </td>
                                        <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                            <a href="edithitung.php?id_barang=<?php echo $data['id_barang']; ?>">
                                                <button class="inline-block px-6 py-2.5 bg-yellow-300 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-yellow-400 hover:shadow-lg focus:bg-yellow-500 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-orange-500 active:shadow-lg transition duration-150 ease-in-out">
                                                    Ubah
                                                </button>
                                            </a>
                                        </td>
